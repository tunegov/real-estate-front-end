...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_material_ui_styles__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_material_ui_styles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_material_ui_styles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_material_ui_Input__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_uuid_v4__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_debounce__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_material_ui_Select__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_material_ui_Input__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_material_ui_Menu__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_material_ui_Chip__ = __webpack_require__(89);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_material_ui_styles__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_material_ui_styles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_material_ui_styles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_material_ui_Radio__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_MaterialCustomSelectInput__ = __webpack_require__(95);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_graphql_request__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_graphQLEndpoint__ = __webpack_require__(7);
...
var v4_ = __webpack_require__(67);
...
var TextField_ = __webpack_require__(94);
...
var MaterialCustomTextFieldWrapper = __webpack_require__(92);

// EXTERNAL MODULE: ./components/MaterialCustomRadioInputWrapper/index.js
var MaterialCustomRadioInputWrapper = __webpack_require__(105);

// EXTERNAL MODULE: ./components/MaterialCustomSelectInputWrapper/index.js
var MaterialCustomSelectInputWrapper = __webpack_require__(93);

// EXTERNAL MODULE: ./components/CustomFileUploadInputWrapper/index.js
var CustomFileUploadInputWrapper = __webpack_require__(104);

// EXTERNAL MODULE: ./utils/stringUtils.js
var stringUtils = __webpack_require__(17);

// EXTERNAL MODULE: external "material-ui/Input"
var Input_ = __webpack_require__(63);
...
var external__email_validator_ = __webpack_require__(90);
...
var Menu_ = __webpack_require__(66);
var Menu__default = /*#__PURE__*/__webpack_require__.n(Menu_);
...
var initialize_ = __webpack_require__(169);
...
var ExpansionPanel_ = __webpack_require__(106);
...
var ExpandMore_ = __webpack_require__(108);
...
var MaterialCustomSelectInput = __webpack_require__(95);
...
var external__react_sizes_ = __webpack_require__(68);
...
var dx_react_grid_ = __webpack_require__(96);
      ...
      value: function value() {
        return _this.props.deals.map(function (deal) {
          ...
          return {
            ...
            deductionsTotal: "$".concat(Number(deductionsTotal).toLocaleString()),
            paymentsTotal: "$".concat(Number(paymentsTotal).toLocaleString()),
            netPaymentsTotal: "$".concat(Number(total).toLocaleString()),
            ...
            netCompanyCommission: status === 'pending' ? undefined : "$".concat(Object(utils_Math["a" /* padStringToDecimalString */])(Number(netCompanyCommission).toLocaleString())),
...
/* harmony default export */ var AdminAreaDealsTableContainer = (Object(styles_["withStyles"])(AdminAreaDealsTableContainer_styles)(AdminAreaDealsTableContainer_DealsTableContainer));
// EXTERNAL MODULE: external "material-ui/Dialog"
var Dialog_ = __webpack_require__(41);
var Dialog__default = /*#__PURE__*/__webpack_require__.n(Dialog_);
...
// CONCATENATED MODULE: ./components/AdminDealsSummary/index.js
var AdminDealsSummary__dec, AdminDealsSummary__class;

function AdminDealsSummary__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { AdminDealsSummary__typeof = function _typeof(obj) { return typeof obj; }; } else { AdminDealsSummary__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return AdminDealsSummary__typeof(obj); }

function AdminDealsSummary__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AdminDealsSummary__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AdminDealsSummary__createClass(Constructor, protoProps, staticProps) { if (protoProps) AdminDealsSummary__defineProperties(Constructor.prototype, protoProps); if (staticProps) AdminDealsSummary__defineProperties(Constructor, staticProps); return Constructor; }

function AdminDealsSummary__possibleConstructorReturn(self, call) { if (call && (AdminDealsSummary__typeof(call) === "object" || typeof call === "function")) { return call; } return AdminDealsSummary__assertThisInitialized(self); }

function AdminDealsSummary__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function AdminDealsSummary__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function AdminDealsSummary__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var AdminDealsSummary_chance = new external__chance__default.a();

var AdminDealsSummary_styles = function styles(theme) {
  var _graphWrapper;
  ...
  return {
    ...
    graphWrapper2: (_graphWrapper = {
      ...
      padding: '10px',
      height: '500px'
    }, AdminDealsSummary__defineProperty(_graphWrapper, theme.breakpoints.down('sm'), {
      height: '670px'
    }), AdminDealsSummary__defineProperty(_graphWrapper, "maxHeight", '100%'), AdminDealsSummary__defineProperty(_graphWrapper, "maxWidth", '100%'), AdminDealsSummary__defineProperty(_graphWrapper, "backgroundColor", '#fff'), AdminDealsSummary__defineProperty(_graphWrapper, "fontSize", '12px'), AdminDealsSummary__defineProperty(_graphWrapper, "boxShadow", theme.shadows[1]), AdminDealsSummary__defineProperty(_graphWrapper, "borderRadius", '5px'), AdminDealsSummary__defineProperty(_graphWrapper, "display", 'flex'), AdminDealsSummary__defineProperty(_graphWrapper, "justifyContent", 'center'), _graphWrapper),
...
var AdminDealsSummary_mapSizesToProps = function mapSizesToProps(_ref) {
...
var AdminDealsSummary_AdminDealsSummary = (AdminDealsSummary__dec = external__react_sizes__default()(AdminDealsSummary_mapSizesToProps), Object(external__mobx_react_["observer"])(AdminDealsSummary__class = AdminDealsSummary__dec(AdminDealsSummary__class =
/*#__PURE__*/
function (_Component) {
  AdminDealsSummary__inherits(AdminDealsSummary, _Component);
  ...
  function AdminDealsSummary() {
    ...
    AdminDealsSummary__classCallCheck(this, AdminDealsSummary);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return AdminDealsSummary__possibleConstructorReturn(_this, (_temp = _this = AdminDealsSummary__possibleConstructorReturn(this, (_ref2 = AdminDealsSummary.__proto__ || Object.getPrototypeOf(AdminDealsSummary)).call.apply(_ref2, [this].concat(args))), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleMonthlyDealsNumberLineGraph", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleMonthlyDealsDollarLineGraph", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleMonthlyDealsDollarOrNum", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleTotalDealsPieDollarOrNum", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleYearlyDealsNumberGraph", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "toggleYearlyDealsDollarGraph", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "barGraphLayout", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "dollarBarGraphAxis", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "numberBarGraphAxis", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(axis, isYear) {
  ...
  AdminDealsSummary__createClass(AdminDealsSummary, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          classes = _props.classes,
      ...
      return external__react__default.a.createElement("div", {
      ...
      }, "Total Deals/Net Commissions"), external__react__default.a.createElement(pie_["ResponsivePie"], {
        ...
        className: classes.graphTitle
      }, "Gross Commissions"), external__react__default.a.createElement("div", {
        className: classes.graphControlsWrapper
      }, external__react__default.a.createElement("span", {
        className: classes.graphControlsLabel
...
}(external__react_["Component"])) || AdminDealsSummary__class) || AdminDealsSummary__class);
/* harmony default export */ var components_AdminDealsSummary = (Object(styles_["withStyles"])(AdminDealsSummary_styles)(AdminDealsSummary_AdminDealsSummary));
...
// CONCATENATED MODULE: ./containers/AdminDealsSummary.js
var containers_AdminDealsSummary__class, _class2, _temp, AdminDealsSummary__initialiseProps;

function containers_AdminDealsSummary__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { containers_AdminDealsSummary__typeof = function _typeof(obj) { return typeof obj; }; } else { containers_AdminDealsSummary__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return containers_AdminDealsSummary__typeof(obj); }

function containers_AdminDealsSummary__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function containers_AdminDealsSummary__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function containers_AdminDealsSummary__createClass(Constructor, protoProps, staticProps) { if (protoProps) containers_AdminDealsSummary__defineProperties(Constructor.prototype, protoProps); if (staticProps) containers_AdminDealsSummary__defineProperties(Constructor, staticProps); return Constructor; }

function containers_AdminDealsSummary__possibleConstructorReturn(self, call) { if (call && (containers_AdminDealsSummary__typeof(call) === "object" || typeof call === "function")) { return call; } return containers_AdminDealsSummary__assertThisInitialized(self); }

function containers_AdminDealsSummary__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function containers_AdminDealsSummary__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AdminDealsSummary_returnGraphDealType = function returnGraphDealType(deal) {
  var graphDealType;
...
var AdminDealsSummary_AdminDealsSummaryContainer = Object(external__mobx_react_["observer"])(containers_AdminDealsSummary__class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  containers_AdminDealsSummary__inherits(AdminDealsSummaryContainer, _Component);

  function AdminDealsSummaryContainer(props) {
    var _this;

    containers_AdminDealsSummary__classCallCheck(this, AdminDealsSummaryContainer);

    _this = containers_AdminDealsSummary__possibleConstructorReturn(this, (AdminDealsSummaryContainer.__proto__ || Object.getPrototypeOf(AdminDealsSummaryContainer)).call(this, props));

    AdminDealsSummary__initialiseProps.call(containers_AdminDealsSummary__assertThisInitialized(_this));
  ...
  containers_AdminDealsSummary__createClass(AdminDealsSummaryContainer, [{
    key: "render",
    value: function render() {
...
}(external__react_["Component"]), AdminDealsSummary__initialiseProps = function _initialiseProps() {
  var _this2 = this;
  ...
  Object.defineProperty(this, "returnDollarAmtOfTotalDealsData", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      ...
      var grossDealsDollarData = [{
        id: 'Res. Sales',
        label: 'Res. Sales',
        value: Object(utils_Math["b" /* round */])(grossDealDataCounts['Res. Sales'] || 0, 0)
      }, {
        id: 'Res. Rentals',
        label: 'Res. Rentals',
        value: Object(utils_Math["b" /* round */])(grossDealDataCounts['Res. Sales'] || 0, 0)
        ...
        id: 'Com. Sales',
        label: 'Com. Sales',
        value: Object(utils_Math["b" /* round */])(grossDealDataCounts['Com. Sales'] || 0, 0)
      }, {
        id: 'Com. Rentals',
        label: 'Com. Rentals',
        value: Object(utils_Math["b" /* round */])(grossDealDataCounts['Com. Rentals'] || 0, 0)
      }];
      var netDealsDollarData = [{
        id: 'Res. Sales',
        label: 'Res. Sales',
        value: Object(utils_Math["b" /* round */])(netDealDataCounts['Res. Sales'] || 0, 0)
      }, {
        id: 'Res. Rentals',
        label: 'Res. Rentals',
        value: Object(utils_Math["b" /* round */])(netDealDataCounts['Res. Sales'] || 0, 0)
        ...
        id: 'Com. Sales',
        label: 'Com. Sales',
        value: Object(utils_Math["b" /* round */])(netDealDataCounts['Com. Sales'] || 0, 0)
      }, {
        id: 'Com. Rentals',
        label: 'Com. Rentals',
        value: Object(utils_Math["b" /* round */])(netDealDataCounts['Com. Rentals'] || 0, 0)
      }];
      return {
  ...
  Object.defineProperty(this, "returnGrossDealCommissions", {
    ...
    value: function value() {
      var deals = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      return Object(utils_Math["b" /* round */])(deals.reduce(function (grossAmount, deal) {
        if (deal.status === 'pending') return grossAmount;
        return grossAmount += deal.total;
      }, 0), 0);
    }
  });
  Object.defineProperty(this, "returnNetDealCommissions", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
  ...
  Object.defineProperty(this, "returnMonthlyAndYearlyDealsData", {
    ...
    value: function value() {
      ...
      var grossMonthlyDollarData = Object(graphDataModels["b" /* returnMonthlyDollarDataContainer */])();
      ...
      var grossYearlyDollarData = Object(graphDataModels["c" /* returnNumberDealsDataContainer */])();
      ...
      deals.forEach(function (deal) {
        ...
        if (get([returnGraphMonth(month), AdminDealsSummary_returnGraphDealType(deal)], grossMonthlyDollarData)) {
          grossMonthlyDollarData[returnGraphMonth(month)][AdminDealsSummary_returnGraphDealType(deal)] += Object(utils_Math["b" /* round */])(deal.total / 1000);
        } else {
          external__set_value__default()(grossMonthlyDollarData, "".concat(returnGraphMonth(month), ".").concat(AdminDealsSummary_returnGraphDealType(deal)), Object(utils_Math["b" /* round */])(deal.total / 1000));
        } // net monthlyDollarData


        if (get([returnGraphMonth(month), AdminDealsSummary_returnGraphDealType(deal)], monthlyDollarData)) {
          monthlyDollarData[returnGraphMonth(month)][AdminDealsSummary_returnGraphDealType(deal)] += Object(utils_Math["b" /* round */])(deal.netCompanyCommission / 1000);
        } else {
          external__set_value__default()(monthlyDollarData, "".concat(returnGraphMonth(month), ".").concat(AdminDealsSummary_returnGraphDealType(deal)), Object(utils_Math["b" /* round */])(deal.netCompanyCommission / 1000));
        } // monthlyDealNumberData


        if (get([returnGraphMonth(month), AdminDealsSummary_returnGraphDealType(deal)], monthlyDealNumberData)) {
          monthlyDealNumberData[returnGraphMonth(month)][AdminDealsSummary_returnGraphDealType(deal)] += 1;
        } else {
          external__set_value__default()(monthlyDealNumberData, "".concat(returnGraphMonth(month), ".").concat(AdminDealsSummary_returnGraphDealType(deal)), 1);
        }

        if (year >= yearLimit) {
          // gross yearlyDollarData
          if (get([year, AdminDealsSummary_returnGraphDealType(deal)], yearlyDollarData)) {
            grossYearlyDollarData[year][AdminDealsSummary_returnGraphDealType(deal)] += Object(utils_Math["b" /* round */])(deal.total / 1000);
          } else {
            external__set_value__default()(grossYearlyDollarData, "".concat(year, ".").concat(AdminDealsSummary_returnGraphDealType(deal)), Object(utils_Math["b" /* round */])(deal.total / 1000));
          } // yearlyDollarData


          if (get([year, AdminDealsSummary_returnGraphDealType(deal)], yearlyDollarData)) {
            yearlyDollarData[year][AdminDealsSummary_returnGraphDealType(deal)] += Object(utils_Math["b" /* round */])(deal.netCompanyCommission / 1000);
          } else {
            external__set_value__default()(yearlyDollarData, "".concat(year, ".").concat(AdminDealsSummary_returnGraphDealType(deal)), Object(utils_Math["b" /* round */])(deal.netCompanyCommission / 1000));
          } // yearlyDealNumberData


          if (get([year, AdminDealsSummary_returnGraphDealType(deal)], yearlyDealNumberData)) {
            yearlyDealNumberData[year][AdminDealsSummary_returnGraphDealType(deal)] += 1;
          } else {
            external__set_value__default()(yearlyDealNumberData, "".concat(year, ".").concat(AdminDealsSummary_returnGraphDealType(deal)), 1);
          }
        }
      });
      return {
  ...
  Object.defineProperty(this, "returnAllGraphData", {
    ...
    value: function value(deals) {
      var _this2$returnMonthlyA = _this2.returnMonthlyAndYearlyDealsData(deals),
          ...
          grossMonthlyDollarData = _this2$returnMonthlyA.grossMonthlyDollarData,
          monthlyDealNumberData = _this2$returnMonthlyA.monthlyDealNumberData,
          yearlyDollarData = _this2$returnMonthlyA.yearlyDollarData,
          grossYearlyDollarData = _this2$returnMonthlyA.grossYearlyDollarData,
      ...
      return {
        ...
        grossMonthlyDealsDollarBarData: _this2.generateDealsBarData(grossMonthlyDollarData),
        ...
        grossMonthlyDealsDollarLineData: _this2.generateDealsLineData(grossMonthlyDollarData),
        ...
        grossYearlyDealsDollarBarData: _this2.generateDealsBarData(grossYearlyDollarData),
        ...
        grossYearlyDealsDollarLineData: _this2.generateDealsLineData(grossYearlyDollarData),
        yearlyDealsNumberLineData: _this2.generateDealsLineData(yearlyDealNumberData)
      };
    }
  });
}, _temp)) || containers_AdminDealsSummary__class;

/* harmony default export */ var containers_AdminDealsSummary = (AdminDealsSummary_AdminDealsSummaryContainer);
// CONCATENATED MODULE: ./components/AdminDealsSummaryDialogBox/index.js
var AdminDealsSummaryDialogBox__class;

function AdminDealsSummaryDialogBox__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { AdminDealsSummaryDialogBox__typeof = function _typeof(obj) { return typeof obj; }; } else { AdminDealsSummaryDialogBox__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return AdminDealsSummaryDialogBox__typeof(obj); }

function AdminDealsSummaryDialogBox__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AdminDealsSummaryDialogBox__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AdminDealsSummaryDialogBox__createClass(Constructor, protoProps, staticProps) { if (protoProps) AdminDealsSummaryDialogBox__defineProperties(Constructor.prototype, protoProps); if (staticProps) AdminDealsSummaryDialogBox__defineProperties(Constructor, staticProps); return Constructor; }

function AdminDealsSummaryDialogBox__possibleConstructorReturn(self, call) { if (call && (AdminDealsSummaryDialogBox__typeof(call) === "object" || typeof call === "function")) { return call; } return AdminDealsSummaryDialogBox__assertThisInitialized(self); }

function AdminDealsSummaryDialogBox__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function AdminDealsSummaryDialogBox__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function AdminDealsSummaryDialogBox__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var AdminDealsSummaryDialogBox_styles = function styles(theme) {
  return {
    paper: AdminDealsSummaryDialogBox__defineProperty({
      width: '90%',
      maxWidth: '90%'
    }, theme.breakpoints.down('sm'), {
      width: '100%',
...
var AdminDealsSummaryDialogBox_AdminDealsSummaryDialogBox = Object(external__mobx_react_["observer"])(AdminDealsSummaryDialogBox__class =
/*#__PURE__*/
function (_Component) {
  AdminDealsSummaryDialogBox__inherits(AdminDealsSummaryDialogBox, _Component);

  function AdminDealsSummaryDialogBox() {
    AdminDealsSummaryDialogBox__classCallCheck(this, AdminDealsSummaryDialogBox);

    return AdminDealsSummaryDialogBox__possibleConstructorReturn(this, (AdminDealsSummaryDialogBox.__proto__ || Object.getPrototypeOf(AdminDealsSummaryDialogBox)).apply(this, arguments));
  }

  AdminDealsSummaryDialogBox__createClass(AdminDealsSummaryDialogBox, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          fullScreen = _props.fullScreen,
      ...
      }, external__react__default.a.createElement(containers_AdminDealsSummary, {
  ...
  return AdminDealsSummaryDialogBox;
}(external__react_["Component"])) || AdminDealsSummaryDialogBox__class;

/* harmony default export */ var components_AdminDealsSummaryDialogBox = (Object(Dialog_["withMobileDialog"])()(Object(styles_["withStyles"])(AdminDealsSummaryDialogBox_styles)(AdminDealsSummaryDialogBox_AdminDealsSummaryDialogBox)));
...
// CONCATENATED MODULE: ./containers/AdminAreaDealsContainer.js
var AdminAreaDealsContainer__class;
...
function AdminAreaDealsContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { AdminAreaDealsContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { AdminAreaDealsContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return AdminAreaDealsContainer__typeof(obj); }

function AdminAreaDealsContainer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { AdminAreaDealsContainer__defineProperty(target, key, source[key]); }); } return target; }

function AdminAreaDealsContainer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function AdminAreaDealsContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AdminAreaDealsContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AdminAreaDealsContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) AdminAreaDealsContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) AdminAreaDealsContainer__defineProperties(Constructor, staticProps); return Constructor; }

function AdminAreaDealsContainer__possibleConstructorReturn(self, call) { if (call && (AdminAreaDealsContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return AdminAreaDealsContainer__assertThisInitialized(self); }

function AdminAreaDealsContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function AdminAreaDealsContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AdminAreaDealsContainer_Loader = external__react_spinners_["DotLoader"];

var AdminAreaDealsContainer_styles = function styles(theme) {
  return {
    dealsSummaryBtn: {
      backgroundColor: '#2995F3',
      color: '#fff',
...
var allDealsByDateRangeQuery = external__graphql_tag__default()(_templateObject);
var allDealsByAgentNameQuery = external__graphql_tag__default()(_templateObject2);
var dealsByAgentRealEstateLicenseNumberQuery = external__graphql_tag__default()(_templateObject3);
var dealQuery = external__graphql_tag__default()(_templateObject4);
var allDealsByClientNameQuery = external__graphql_tag__default()(_templateObject5);
var dealsQuery = external__graphql_tag__default()(_templateObject6);

var AdminAreaDealsContainer_AdminAreaDealsContainer = Object(external__mobx_react_["observer"])(AdminAreaDealsContainer__class =
/*#__PURE__*/
function (_Component) {
  AdminAreaDealsContainer__inherits(AdminAreaDealsContainer, _Component);

  function AdminAreaDealsContainer(props) {
    var _this;

    AdminAreaDealsContainer__classCallCheck(this, AdminAreaDealsContainer);

    _this = AdminAreaDealsContainer__possibleConstructorReturn(this, (AdminAreaDealsContainer.__proto__ || Object.getPrototypeOf(AdminAreaDealsContainer)).call(this, props));
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "returnQuery", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "returnQueryName", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "returnQueryVariables", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "toggleDealsSummaryDialogBox", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "onStartDateCHange", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "onEndDateCHange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(date) {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "onDateRangeSearch", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "onSpecificSearch", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "openDealsViewDialogBox", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "closeDealsViewDialogBox", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "deleteDeal", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(dealID) {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "dealDeleted", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(dealID) {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "dealAccepted", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(dealID) {
    ...
    Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "handleCloseSnackbar", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
  ...
  AdminAreaDealsContainer__createClass(AdminAreaDealsContainer, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external__react__default.a.createElement(external__react_apollo_["Query"], {
        ...
        }, external__react__default.a.createElement(AdminAreaDealsContainer_Loader, {
          color: "#f44336",
          loading: true
        }));
        var intDeals = {};
        ...
        uniqueDeals = uniqueDeals.filter(function (deal) {
          ...
          if (_this2.state.acceptedDealIDS.includes(deal.dealID)) {
            return AdminAreaDealsContainer__objectSpread({}, deal, {
              status: 'accepted'
            });
          } else {
            return deal;
        ...
        }, external__react__default.a.createElement(Equalizer__default.a, null), "Deals Summary"))), external__react__default.a.createElement(ViewDealDialogBox["a" /* default */], {
        ...
        }), external__react__default.a.createElement(AdminAreaDealsTableContainer, {
          deals: uniqueDeals,
          openDealsViewDialogBox: _this2.openDealsViewDialogBox
        }), external__react__default.a.createElement(components_AdminDealsSummaryDialogBox, {
...
}(external__react_["Component"])) || AdminAreaDealsContainer__class;

/* harmony default export */ var containers_AdminAreaDealsContainer = (Object(styles_["withStyles"])(AdminAreaDealsContainer_styles)(AdminAreaDealsContainer_AdminAreaDealsContainer));
// CONCATENATED MODULE: ./pages/app/admin-area/deals/view.js
var view__class;
...
var view_Deals = Object(external__mobx_react_["observer"])(view__class =
/*#__PURE__*/
function (_React$Component) {
  view__inherits(Deals, _React$Component);

  view__createClass(Deals, null, [{
    key: "getInitialProps",
  ...
  function Deals(props) {
    ...
    view__classCallCheck(this, Deals);

    _this = view__possibleConstructorReturn(this, (Deals.__proto__ || Object.getPrototypeOf(Deals)).call(this, props));
...
/* harmony default export */ var view = __webpack_exports__["default"] = (Object(withData["a" /* default */])(view_Deals));
