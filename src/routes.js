...
routes
  ...
  .add('admin-dashboard', '/app/admin-area/dashboard', 'app/admin-area/dashboard')
  .add('create-agent', '/app/admin-area/agents/create', 'app/admin-area/agents/create')
  .add('view-agents', '/app/admin-area/agents/view', 'app/admin-area/agents/view')
  .add('create-user', '/app/admin-area/users/create', 'app/admin-area/users/create')
  .add('view-users', '/app/admin-area/users/view', 'app/admin-area/users/view')
  .add('create-admin', '/app/admin-area/admin/create', 'app/admin-area/admin/create')
  ...
  .add('view-invoices', '/app/admin-area/invoices/view', 'app/admin-area/invoices/view')
  .add('log-in', '/log-in')
  .add('sign-up', '/sign-up')
