...
var submitNewsAlertItem_submitNewsAlertItem = function submitNewsAlertItem(values) {
  var res;
  var variables = {
    input: values
  };
...
/* harmony default export */ var general_submitNewsAlertItem = (submitNewsAlertItem_submitNewsAlertItem);
...
var deleteNewsAlertItem_deleteNewsAlertItem = function deleteNewsAlertItem(uuid) {
  ...
  return client["a" /* graphQlClient */].request(deleteNewsAlertItem_query, variables).then(function (result) {
    res = result;
    console.log(res);
    var _res = res,
...
var Star_ = __webpack_require__(174);
...
var AdminDashboard_styles = function styles() {
  return {
    root: {
      maxWidth: '100%',
      marginBottom: 10
  ...
  function DashboardContainer() {
    ...
    return AdminDashboard__possibleConstructorReturn(_this, (_temp = _this = AdminDashboard__possibleConstructorReturn(this, (_ref = DashboardContainer.__proto__ || Object.getPrototypeOf(DashboardContainer)).call.apply(_ref, [this].concat(args))), Object.defineProperty(AdminDashboard__assertThisInitialized(_this), "state", {
      ...
      value: function value() {
        ...
        return {
          netCommissionsToDate: Object(currency["a" /* toLocaleCurrency */])(netCommissionsToDate),
          currentMonthNetCommissions: Object(currency["a" /* toLocaleCurrency */])(currentMonthNetCommissions),
          currentMonthNumOfDealsCommissions: currentMonthNumOfDealsCommissions,
          numOfPendingDeals: numOfPendingDeals,
          grossCommissionsToDate: Object(currency["a" /* toLocaleCurrency */])(grossCommissionsToDate)
        };
      }
  ...
  AdminDashboard__createClass(DashboardContainer, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(external__react_apollo_["Query"], {
        ...
        return external__react__default.a.createElement("div", null, external__react__default.a.createElement(components_AdminDashboard, {
...
function (_React$Component) {
  ...
  dashboard__createClass(Dashboard, [{
    key: "render",
    value: function render() {
      var userUUID = this.state.userUUID;
      var UUID = this.store.UserStore.uuid || userUUID;
