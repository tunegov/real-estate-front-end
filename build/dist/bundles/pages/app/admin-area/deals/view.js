...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Math__ = __webpack_require__(72);
...
var external__react_images_ = __webpack_require__(143);
...
var SubmitDealForm = __webpack_require__(148);

// EXTERNAL MODULE: ./effects/deals/getDealUploadsSignedURLS.js
var getDealUploadsSignedURLS = __webpack_require__(149);

// EXTERNAL MODULE: ./effects/uploadFile.js
var uploadFile = __webpack_require__(150);
...
var deleteDeal = __webpack_require__(151);
...
var defaultHiddenColumnNames = ['paymentsTotal', 'propertyState', 'clientEmail', 'managementOrCobrokeCompany', 'bonusPercentageAddedByAdmin', 'propertyCity', 'coBrokeringAgent'];
      ...
      value: function value() {
        ...
        return deals.map(function (deal) {
          ...
          var coBrokeAgents = deductionItems && deductionItems.filter(function (v) {
            return v.deductionType === 'Co-Brokering Split' && v.agentName;
          }).map(function (v) {
            return v.agentName;
          }).join(', ');
          return {
...
var initialize_ = __webpack_require__(179);
...
var AdminAreaDealsTableContainer = __webpack_require__(180);
...
var external__set_value_ = __webpack_require__(157);
...
var external__react_toggle_button_ = __webpack_require__(161);
  ...
  _createClass(AdminDealsSummary, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          grossDealCommissions = _props.grossDealCommissions,
          netDealCommissions = _props.netDealCommissions,
          netCurrentYearDealCommissions = _props.netCurrentYearDealCommissions,
          numberOfPendingDeals = _props.numberOfPendingDeals,
          numberOfTotalDealsData = _props.numberOfTotalDealsData,
          netDollarAmtOfTotalDealsData = _props.netDollarAmtOfTotalDealsData;
      var _state = this.state,
      ...
      return external__react__default.a.createElement("div", {
      ...
      })), numberOfTotalDealsData ? external__react__default.a.createElement(Grid__default.a, {
        item: true,
        xs: 12
      }, external__react__default.a.createElement("div", {
        ...
        data: totalDealsPieDollarOrNum === 'number' ? numberOfTotalDealsData : netDollarAmtOfTotalDealsData,
        margin: {
          top: 70,
          right: 80,
          bottom: 120,
...
var dealTypes = __webpack_require__(162);

// EXTERNAL MODULE: ./utils/Math.js
var utils_Math = __webpack_require__(72);

// EXTERNAL MODULE: ./constants/graphDataModels.js
var graphDataModels = __webpack_require__(163);

// EXTERNAL MODULE: ./utils/currency.js
var currency = __webpack_require__(137);

// CONCATENATED MODULE: ./containers/AdminDealsSummary.js
var AdminDealsSummary__class;
...
var AdminDealsSummary_AdminDealsSummaryContainer = Object(external__mobx_react_["observer"])(AdminDealsSummary__class =
/*#__PURE__*/
function (_Component) {
  ...
  function AdminDealsSummaryContainer(props) {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnNumberOfTotalDealsData", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnDollarAmtOfTotalDealsData", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnNumberOfPendingDeals", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnGrossDealCommissions", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnNetDealCommissions", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnNetCurrentYearDealCommissions", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnMonthlyAndYearlyDealsData", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "generateDealsBarData", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "generateDealsLineData", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(data) {
    ...
    Object.defineProperty(AdminDealsSummary__assertThisInitialized(_this), "returnAllGraphData", {
      configurable: true,
      enumerable: true,
      writable: true,
...
}(external__react_["Component"])) || AdminDealsSummary__class;
...
var ViewDealDialogBox = __webpack_require__(164);
...
function (_Component) {
  ...
  function AdminAreaDealsContainer() {
    var _ref;
    ...
    return AdminAreaDealsContainer__possibleConstructorReturn(_this, (_temp = _this = AdminAreaDealsContainer__possibleConstructorReturn(this, (_ref = AdminAreaDealsContainer.__proto__ || Object.getPrototypeOf(AdminAreaDealsContainer)).call.apply(_ref, [this].concat(args))), Object.defineProperty(AdminAreaDealsContainer__assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
      ...
      writable: true,
      value: function value(_ref2) {
        var dealID = _ref2.dealID,
            status = _ref2.status,
            isCoAgent = _ref2.isCoAgent,
