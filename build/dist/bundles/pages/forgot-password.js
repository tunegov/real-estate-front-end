...
var external__debounce_ = __webpack_require__(37);
...
var icon_style_css_ = __webpack_require__(21);
...
// EXTERNAL MODULE: external "antd/lib/button/style/css"
var css_ = __webpack_require__(78);
var css__default = /*#__PURE__*/__webpack_require__.n(css_);
...
// CONCATENATED MODULE: ./frontEndComponents/ForgotPassword/index.js
...
var ForgotPassword_styles = function styles(theme) {
  return {
    root: {
      display: 'flex',
      justifyContent: 'center',
...
var ForgotPassword_ForgotPassword = (_dec = Object(styles_["withStyles"])(ForgotPassword_styles), _dec(_class = Object(external__mobx_react_["observer"])(_class =
/*#__PURE__*/
function (_React$Component) {
  ...
  function ForgotPassword() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ForgotPassword.__proto__ || Object.getPrototypeOf(ForgotPassword)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "formSubmitted", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: false
      ...
      value: function value(values) {
        ...
        _this.props.resetPassword({
          forgotPasswordToken: _this.props.forgotPasswordToken,
          password: values.password
        }).then(function (res) {
          console.log(res);
  ...
  _createClass(ForgotPassword, [{
    ...
    value: function render() {
      ...
      var passwordError = (isFieldTouched('password') || this.formSubmitted) && getFieldError('password');
      var passwordConfirmationError = (isFieldTouched('passwordConfirmation') || this.formSubmitted) && getFieldError('passwordConfirmation');
      ...
      var validateToNextPassword = function validateToNextPassword(rule, value, callback) {
        ...
        if (!value || value.length < 8 || value.length > 30) {
          callback('Please input your new password. Must be between 8 and 30 characters long!');
        } else {
          callback();
        }
      };
      ...
      return external__react__default.a.createElement("div", {
      ...
      }, "Password Reset"), this.state.errorsFromServer ? this.renderServerErrorMessage() : null, external__react__default.a.createElement("div", {
        style: {
          display: submittingFormToServer || loadingNextPage || passwordSuccessfullyReset ? 'none' : undefined
        }
      }, external__react__default.a.createElement(form__default.a, {
        ...
        rules: [{
          required: true,
          message: 'Please input your new password. Must be between 8 and 30 characters long!',
          min: 8,
          max: 30,
          whitespace: true,
        ...
        rules: [{
          required: true,
          message: 'Please confirm your password. Passwords must match!',
          whitespace: true,
          validator: function validator(rule, value, callback) {
            if (!value || !value.trim()) {
              callback('Please confirm your password. Passwords must match!');
      ...
      }), isForgotPasswordType ? 'Reset Password' : 'Submit')), external__react__default.a.createElement("div", {
        className: classes.forgotPasswordWrapper
        ...
        onClick: this.toggleIsForgotPasswordType,
        className: classes.forgotPassword
      }, "Cancel")))), passwordSuccessfullyReset ? external__react__default.a.createElement("div", {
        className: classes.formSubmittingWrapper
      }, external__react__default.a.createElement("div", {
        className: classes.progressBarExplanation
      }, "Password reset!")) : null, submittingFormToServer || loadingNextPage ? external__react__default.a.createElement("div", {
        className: classes.formSubmittingWrapper
      }, external__react__default.a.createElement(icon__default.a, {
        type: "loading",
        style: {
...
/* harmony default export */ var frontEndComponents_ForgotPassword = (form__default.a.create()(ForgotPassword_ForgotPassword));
// EXTERNAL MODULE: ./effects/client.js
var client = __webpack_require__(6);

// CONCATENATED MODULE: ./effects/users/resetPassword.js

var query = "\n    mutation resetPassword($input: ResetPasswordInput!) {\n      resetPassword(input: $input) {\n        wasSuccessful\n        userErrors {\n          field\n          message\n        }\n      }\n    }\n  ";

var resetPassword_resetPassword = function resetPassword(input) {
  var variables = {
    input: input
  };
  var finalResponseObj = {
...
/* harmony default export */ var users_resetPassword = (resetPassword_resetPassword);
// CONCATENATED MODULE: ./pages/forgot-password.js
var forgot_password__class;

function forgot_password__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { forgot_password__typeof = function _typeof(obj) { return typeof obj; }; } else { forgot_password__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return forgot_password__typeof(obj); }

function forgot_password__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function forgot_password__possibleConstructorReturn(self, call) { if (call && (forgot_password__typeof(call) === "object" || typeof call === "function")) { return call; } return forgot_password__assertThisInitialized(self); }

function forgot_password__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function forgot_password__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function forgot_password__createClass(Constructor, protoProps, staticProps) { if (protoProps) forgot_password__defineProperties(Constructor.prototype, protoProps); if (staticProps) forgot_password__defineProperties(Constructor, staticProps); return Constructor; }

function forgot_password__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var forgot_password_ForgotPassword = Object(external__mobx_react_["observer"])(forgot_password__class =
/*#__PURE__*/
function (_React$Component) {
  forgot_password__inherits(ForgotPassword, _React$Component);

  forgot_password__createClass(ForgotPassword, null, [{
    key: "getInitialProps",
  ...
  function ForgotPassword(props) {
    ...
    forgot_password__classCallCheck(this, ForgotPassword);

    _this = forgot_password__possibleConstructorReturn(this, (ForgotPassword.__proto__ || Object.getPrototypeOf(ForgotPassword)).call(this, props));
  ...
  forgot_password__createClass(ForgotPassword, [{
    key: "render",
    value: function render() {
      var forgotPasswordToken = this.props.forgotPasswordToken;
      return external__react__default.a.createElement(FrontEndLayout["a" /* default */], {
        UserStore: this.store.UserStore
      }, external__react__default.a.createElement(frontEndComponents_ForgotPassword, {
  ...
  return ForgotPassword;
}(external__react__default.a.Component)) || forgot_password__class;

/* harmony default export */ var forgot_password = __webpack_exports__["default"] = (Object(withData["a" /* default */])(forgot_password_ForgotPassword));
