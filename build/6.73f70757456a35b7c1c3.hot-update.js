  ...
  function ViewDealFormContainer(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "onSubmit", {
      ...
      value: function value(values) {
        var setFormSubmitted = _this.props.setFormSubmitted;
        setFormSubmitted();
        ...
        Object(__WEBPACK_IMPORTED_MODULE_6__effects_deals_getDealUploadsSignedURLS__["a" /* default */])(uploadItems, _this.props.dealID).then(function (response) {
          if (response.error) {
          ...
          console.log('this.props.dealID', _this.props.dealID);
...
//# sourceMappingURL=6.73f70757456a35b7c1c3.hot-update.js.map