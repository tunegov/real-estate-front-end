    ...
    value: function render() {
      ...
      if (isViewType && submittedDeal && submittedDeal.deductionItems.length) {
        ...
        submittedDeal.deductionItems.forEach(function (item) {
          if (item.deductionType === 'Co-Brokering Split' && !agentUUIDS.includes(item.agentID)) {
            console.log(agents);
            console.log(item);
            console.log(agentUUID);

            var _agents$find = agents.find(function (agent) {
              return agent.uuid === item.agentID || agent.uuid === agentUUID;
            }),
                firstName = _agents$find.firstName,
                lastName = _agents$find.lastName;

            var agentName = "".concat(Object(__WEBPACK_IMPORTED_MODULE_30__utils_stringUtils__["a" /* capitalize */])(firstName), " ").concat(Object(__WEBPACK_IMPORTED_MODULE_30__utils_stringUtils__["a" /* capitalize */])(lastName), " (Agent ID - ").concat(__WEBPACK_IMPORTED_MODULE_11_uuid_v4___default.a, ")");
...
//# sourceMappingURL=6.ec2bed048558465898fc.hot-update.js.map