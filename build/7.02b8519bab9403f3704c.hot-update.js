      ...
      value: function value() {
        ...
        deals.forEach(function (deal) {
          ...
          if (get([returnGraphMonth(month), returnGraphDealType(deal)], grossMonthlyDollarData)) {
            grossMonthlyDollarData[returnGraphMonth(month)][returnGraphDealType(deal)] += deal.total / 1000;
          } else {
            __WEBPACK_IMPORTED_MODULE_3_set_value___default()(grossMonthlyDollarData, "".concat(returnGraphMonth(month), ".").concat(returnGraphDealType(deal)), deal.total / 1000);
          ...
          if (year >= yearLimit) {
            ...
            if (get([year, returnGraphDealType(deal)], yearlyDollarData)) {
              grossYearlyDollarData[year][returnGraphDealType(deal)] += deal.total / 1000;
            } else {
              __WEBPACK_IMPORTED_MODULE_3_set_value___default()(grossYearlyDollarData, "".concat(year, ".").concat(returnGraphDealType(deal)), deal.total / 1000);
            } // yearlyDollarData
        ...
        return {
          ...
          grossMonthlyDollarData: Object(__WEBPACK_IMPORTED_MODULE_6__utils_Math__["b" /* round */])(grossMonthlyDollarData),
          monthlyDealNumberData: monthlyDealNumberData,
          yearlyDollarData: yearlyDollarData,
          grossYearlyDollarData: Object(__WEBPACK_IMPORTED_MODULE_6__utils_Math__["b" /* round */])(grossYearlyDollarData),
...
//# sourceMappingURL=7.02b8519bab9403f3704c.hot-update.js.map