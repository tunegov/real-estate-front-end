        ...
        deals.forEach(function (deal) {
          ...
          if (year >= yearLimit) {
            ...
            if (get([year, returnGraphDealType(deal)], yearlyDollarData)) {
              grossYearlyDollarData[year][returnGraphDealType(deal)] += Object(__WEBPACK_IMPORTED_MODULE_8__utils_currency__["a" /* toLocaleCurrency */])(deal.total / 1000);
            } else {
              __WEBPACK_IMPORTED_MODULE_3_set_value___default()(grossYearlyDollarData, "".concat(year, ".").concat(returnGraphDealType(deal)), Object(__WEBPACK_IMPORTED_MODULE_8__utils_currency__["a" /* toLocaleCurrency */])(deal.total / 1000));
            } // yearlyDollarData
...
//# sourceMappingURL=7.46f402b04ae45d13ee82.hot-update.js.map